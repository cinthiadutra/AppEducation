...
class CustomDropDownState extends StatelessWidget {
  ...
  _buildDropDownWidget() {
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        items: items?.map<DropdownMenuItem<States>>((States value) {
        ...
        onChanged: (value) {
          var states = value as States;
          onChanged!(states.prefix);
        },
      ),
    );
  }
