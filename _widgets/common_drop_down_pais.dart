...
class CustomDropDownPais extends StatelessWidget {
  const CustomDropDownPais(
      {super.key,
      this.onSaved,
      this.shape,
      this.padding,
  ...
  _buildDropDownWidget() {
    return Container(
      ...
      child: DropdownButtonFormField(
          ...
          items: items?.map<DropdownMenuItem<Country>>((Country value) {
          ...
          onChanged: (value) {
            ...
            onChanged!(country.prefix);
          },
          onSaved: (value) {
            var nameCountry = value as Country;
            onSaved!(nameCountry.name);
          }),
    );
  }
